...
//program takes in a first and last name (via C-Strings), then outputs 3 possible usernames based on those inputs
...
int main () {
    ...
    char firstName[10];                 //this is the C-String that the user's first name will be placed in
    char lastName[20];                  //this is the C-String that the user's last name will be placed in
    ...
    while (i[0] != 0) {             //this is the start of the first loop, designed to get the user's first name
        ...
        cin >> firstName;           //user inputs their first name into the string
            ...
            if (strlen(firstName) > 10) {                   //the following 7 lines are used to determine if the First name is too long or not
    ...
    while (i[1] != 0) {             //this is the start of the first loop, designed to get the user's last name
        ...
        cin >> lastName;            //user inputs their last name into the string
            ...
            if (strlen(lastName) > 20) {                   //the following 7 lines are used to determine if the last name is too long or not
    ...
    if (strcmp(firstName, lastName) == 0) {                 //this then checks to insure the first and last name aren't the same
